// src/components/consejos-populares/ModalForm.tsx
import {
  Check,
  Hash,
  Loader2,
  ...
  return (
    ...
    >
      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-200 rounded-2xl border border-black/[0.07] bg-white shadow-xl dark:border-white/[0.07] dark:bg-[#0e1a35]">
        ...
        <div className="max-h-[70vh] overflow-y-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden p-5">
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              {form.presidenteId &&
                (() => {
                  const p = presidentes?.find(
                    (u) => u.id === form.presidenteId,
                  );
                  return p ? (
        ...
        {/* Footer con botones */}
        <div className="border-t border-black/[0.07] bg-[#f8f9fc] px-5 py-4 rounded-b-2xl dark:border-white/[0.07] dark:bg-white/3">
