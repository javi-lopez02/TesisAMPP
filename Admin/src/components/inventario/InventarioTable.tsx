  ...
  return (
    <div className="overflow-x-auto rounded-xl border border-black/[0.07] bg-white dark:border-white/[0.07] dark:bg-[#0e1a35]">
      <div style={{ minWidth: "800px" }}>
        {/* Cabecera */}
        <div
          className="grid items-center border-b border-black/6 bg-[#f8f9fc] px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-gray-500 dark:border-white/6 dark:bg-[#1a2440] dark:text-gray-300"
          style={{
        ...
        {inventarios.length === 0 ? (
          ...
          inventarios.map((inv, i) => {
            ...
            const isLowStock = inv.saldoActual < inv.cantidadAsignada * 0.3;

            return (
              <div
                key={inv.id}
                className={`grid items-center px-5 py-3.5 transition hover:bg-gray-50 dark:hover:bg-white/3 ${
                ...
                style={{
                  gridTemplateColumns:
                    "1.5fr 120px 140px 100px 100px 80px 40px",
                }}
              >
                {/* Combustible: Nombre + Código */}
                {/* ✅ min-w-0 + truncate para evitar desbordamiento de texto */}
                <div className="flex items-center gap-3 min-w-0">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="font-mono text-[11px] text-gray-400 dark:text-gray-400 truncate">
                ...
                <div className="text-right">
                  <p className="font-mono text-[13px] font-bold text-[#0e1f4d] dark:text-white whitespace-nowrap">
                    {inv.cantidadAsignada.toLocaleString("es-CU")} L
                  </p>
                </div>
                ...
                <div className="flex justify-center">
                  <StatPill value={inv._count?.movimientos ?? 0} label="Mov." />
                </div>

                {/* Fecha de actualización */}
                <div className="flex justify-center">
                  <div className="flex items-center gap-1 text-[11px] text-gray-400 dark:text-gray-400 whitespace-nowrap">
                    <Calendar
                      size={10}
