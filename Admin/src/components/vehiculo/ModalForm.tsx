// src/components/vehiculos/ModalForm.tsx
      ...
      <div className="w-full max-w-md animate-in fade-in zoom-in-95 duration-200 rounded-2xl border border-black/[0.07] bg-white shadow-xl dark:border-white/[0.07] dark:bg-[#0e1a35]">
        ...
        <div className="max-h-[70vh] overflow-y-auto [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden p-5">
          <div className="flex flex-col gap-4">
            ...
            <div>
              ...
              {errors.placa ? (
                ...
                <p className="mt-1 text-[11px] text-[#BA7517]">
                  {helpers.validatePlacaFormat(form.placa)}
                </p>
              ) : (
                <p className="mt-1 text-[11px] text-gray-400 dark:text-white/30">
                  {helpers?.PLACA_FORMATO_MSG}
                </p>
              )}
            </div>
            ...
            <div>
              <label className="mb-1.5 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wide text-gray-400 dark:text-white/40">
                <Fuel size={11} /> Capacidad de tanque (L){" "}
                <span className="text-[#CC1A2E]">*</span>
              </label>
              <input
                type="number"
            ...
            <div>
              <label className="mb-1.5 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wide text-gray-400 dark:text-white/40">
                <Gauge size={11} /> Kilometraje actual{" "}
                <span className="text-[#CC1A2E]">*</span>
              </label>
              <input
                type="number"
            ...
            <div>
              <label className="mb-1.5 flex items-center gap-1.5 text-[11px] font-bold uppercase tracking-wide text-gray-400 dark:text-white/40">
                <Wrench size={11} /> Estado{" "}
                <span className="text-[#CC1A2E]">*</span>
              </label>
              <select
                value={form.estado}
                onChange={(e) =>
                  onChange({ estado: e.target.value as EstadoVehiculo })
                }
              ...
              {choferSeleccionado && (
                <div className="mb-2 flex items-center gap-2 rounded-lg border border-[#C0DD97] bg-[#EAF3DE] px-3 py-2 dark:border-[#3B6D11]/40 dark:bg-[#3B6D11]/10">
                  <div className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#1B3D8F] text-[10px] font-bold text-white uppercase">
                    {choferSeleccionado.nombre[0]}
                    {choferSeleccionado.apellidos[0]}
                  </div>
                  ...
                  <button
                    ...
                    className="shrink-0 text-[#3B6D11]/60 transition hover:text-[#CC1A2E] dark:text-[#8BC34A]/60 dark:hover:text-[#F09595]"
                    title="Quitar chofer"
                  >
                    <X size={13} />
                  </button>
